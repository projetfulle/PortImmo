...

        {
...

            {
                    ...
                    {    
                            ...
                            $stmt = $DB_con->prepare("UPDATE entreprises SET :nom, :logo, :specialite, :emplacement, :telephone, :email, :image1, :image2, :image3, :image4, :image5, :image6, :presentation WHERE id=:id");
                            ...
                            echo '<strong>Félicitation!</strong> Vous avez bien édité! <a href="../index.php">Accueil</a>';
                            echo '</div>';
                            echo '</div>';
        ...
        <div class="card-body mx-4 mt-4">
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <label for="nom">Nom de l'entreprise</label>
                    <input type="text" id="nom" name="nom" value="<?php echo $resultat['nom']; ?>" class="form-control">
                </div>

                <div class="col-md-6 mt-2">
                    <label for="logo">Logo de l'entrprise</label><br>
                    <input type="file" id="logo" name="logo" value="<?php echo $resultat['logo']; ?>" size="40" class="">
                </div>
                
                <div class="col-md-6 mt-2">
                    <label for="specialite">Spécialité</label><br>
                    <select name="specialite" id="specialite" class="form-control" required>
                    <?php echo isset($resultat['specialite'])?'<option value='.$resultat['specilite'].'>'.$resultat['specialite'].'</option>': ''; ?>
                    <?php echo  $resultat['specialte']!='batiment'? '<option value="batiment"> Bâtiment tout corps d’état</option>': ''; ?>
                    <?php echo  $resultat['specialte']!='genie_civil'? '<option value="genie_civil"> Ouvrages  de génie civils</option>': ''; ?>
                    <?php echo  $resultat['specialte']!='VRD'? '<option value="VRD"> VRD (Voiries et réseaux divers)</option>': ''; ?>
                    <?php echo  $resultat['specialte']!='deco'? '<option value="deco"> Art, decoration et architecture</option>': ''; ?>
                    <?php echo  $resultat['specialte']!='equipementier'? '<option value="equipementier"> equipementier</option>': ''; ?>
                    </select>
                </div>
                ...
                <div class="col-md-6 mt-2">
                    ...
                    <?php echo isset($resultat['emplacement'])?'<option value='.$resultat['emplacement'].'>'.$resultat['emplacement'].'</option>': ''; ?>
                ...
                <div class="col-md-6 mt-2">
                    ...
                    <input type="tel" id="telephone" name="telephone"  class="form-control" value="<?php echo $resultat['telephone']; ?>">
                </div>

                <div class="col-md-6 mt-2">
                    <label for="email">Adresse Email</label><br>
                    <input type="email" id="email" name="email"  class="form-control" value="<?php echo $resultat['email']; ?>">
                </div>

                <div class="col-md-6 mt-2">
                    <label for="image1">Portfolio</label><br>
                    <input type="file" id="image1" name="image1" class="" value="<?php echo $resultat['image1']; ?>">
                    <input type="file" id="image2" name="image2" class="" value="<?php echo $resultat['image2']; ?>">
                    <input type="file" id="image3" name="image3" class="" value="<?php echo $resultat['image3']; ?>">
                    <input type="file" id="image4" name="image4" class="" value="<?php echo $resultat['image4']; ?>">
                    <input type="file" id="image5" name="image5" class="" value="<?php echo $resultat['image5']; ?>">
                    <input type="file" id="image6" name="image6" class="" value="<?php echo $resultat['image6']; ?>">
                </div>

                <div class="col-md-6 mt-2">
                    <label for="presentation">Presentation</label><br>
                    <textarea class="form-control" id="presentation" rows="6" cols="50" name="presentation" required=""><?php echo $resultat['presentation']; ?></textarea>
                </div>
                ...
                <div class="row d-flex mb-4">
                    ...
                    <div class="col-md-1 col-md-5 d-flex mt-5 ml-auto">
                        <div class="text-center">
                            <button type="submit" class="btn btn-grey btn-rounded z-depth-1a waves-effect waves-light" name="editer">Editer</button>
                        </div>
                    </div>
                    <!--Grid column-->
